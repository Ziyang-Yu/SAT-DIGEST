...
class History(torch.nn.Module):
    ...
    def push(self, x, n_id: Optional[Tensor] = None,
        ...
        # input x = [44597, 256]  input nid = [44597]
        # offset tensor([44653, 48263, 52093, 55703, 59313, 62929, 66539, 70149, 73978, 77806,
        #         81636, 85466])
        # count tensor([3610, 3830, 3610, 3610, 3616, 3610, 3610, 3829, 3828, 3830, 3830, 3784])
